...
def app():
    ...
    st.image('images/tutorial/Excel.png')
    ...
    st.image('images/tutorial/Sheets.png')
    st.write('3. Rellena los datos de los alumnos.')
    st.image('images/tutorial/SheetsListo.png')
